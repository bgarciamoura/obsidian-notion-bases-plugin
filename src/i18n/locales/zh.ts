...
const zh: Partial<Record<keyof typeof en, string>> = {
	...
	date_format_preset_label: '预设',
	date_format_pattern_label: '格式模板',
	date_format_custom: '自定义',
	configure_image_folder: '配置图片文件夹',
	field_type_label: '字段类型',
	system_fields_label: '系统字段',
	created_time: '创建时间',
	last_edited_time: '最后编辑时间',
	system_field_readonly: '只读字段，来自文件元数据',
	hide_field: '隐藏字段',
	...
	db_settings_template_folder_name: '模板文件夹',
	db_settings_template_folder_desc: '为此数据库选择模板时，仅显示此文件夹中的模板。',
	db_settings_template_folder_choose: '选择文件夹',
	db_settings_template_folder_none: '整个仓库（无限制）',
