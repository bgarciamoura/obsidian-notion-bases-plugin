...
const ptBR: Partial<Record<keyof typeof en, string>> = {
	...
	date_format_preset_label: 'Predefinição',
	date_format_pattern_label: 'Padrão',
	...
	system_field_readonly: 'Campo somente leitura dos metadados do arquivo',
	...
	db_settings_template_folder_name: 'Pasta de modelos',
	db_settings_template_folder_desc: 'Mostrar apenas modelos desta pasta ao escolher um modelo para este banco de dados.',
	db_settings_template_folder_choose: 'Escolher pasta',
	db_settings_template_folder_none: 'Vault inteiro (sem restrição)',
