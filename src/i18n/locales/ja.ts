...
const ja: Partial<Record<keyof typeof en, string>> = {
	...
	date_format_preset_label: 'プリセット',
	date_format_pattern_label: 'パターン',
	date_format_custom: 'カスタム',
	configure_image_folder: '画像フォルダーを設定',
	field_type_label: 'フィールドタイプ',
	system_fields_label: 'システムフィールド',
	created_time: '作成日時',
	last_edited_time: '最終更新日時',
	system_field_readonly: 'ファイルのメタデータによる読み取り専用フィールド',
	...
	db_settings_template_folder_name: 'テンプレートフォルダー',
	db_settings_template_folder_desc: 'このデータベースのテンプレートを選択する際、このフォルダー内のテンプレートのみを表示します。',
	db_settings_template_folder_choose: 'フォルダーを選択',
	db_settings_template_folder_none: '保管庫全体（制限なし）',
