...
const ja: Partial<Record<keyof typeof en, string>> = {
	...
	configure_rollup: 'Rollup を設定',
	rollup_select_relation: '1. リレーション列',
	rollup_select_relation_placeholder: 'リレーションを選択...',
	rollup_select_target: '2. ターゲット列',
	rollup_select_target_placeholder: '列を選択...',
	rollup_select_function: '3. 集計',
	rollup_no_relations: 'リレーション列が見つかりません。先にリレーション列を追加してください。',
	rollup_fn_sum: '合計',
	rollup_fn_count: 'カウント',
	rollup_fn_avg: '平均',
	rollup_fn_min: '最小',
	rollup_fn_max: '最大',
	rollup_fn_count_values: '一意をカウント',
	rollup_fn_list: 'すべて列挙',
	type_image: '画像',
	type_audio: 'オーディオ',
	...
	formula_desc_comparators: '2 つの値を比較する；条件式と組み合わせて使用',
	...
	tooltip_search: '検索',
	tooltip_toggle_and_or: 'クリックして論理演算子を切り替え',
	tooltip_close: '閉じる',
	tooltip_remove: '削除',
	...
	quick_add_note_title: 'タイトル',
	quick_add_note_title_placeholder: 'ノートのタイトル...',
	quick_add_create: '作成',
	quick_add_create_and_open: '作成して開く',
	quick_add_no_visible_fields: 'このデータベースに編集可能なフィールドがありません',
