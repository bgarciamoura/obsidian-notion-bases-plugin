...
const de: Partial<Record<keyof typeof en, string>> = {
	...
	configure_rollup: 'Rollup konfigurieren',
	rollup_select_relation: '1. Relationsspalte',
	rollup_select_relation_placeholder: 'Relation auswählen...',
	rollup_select_target: '2. Zielspalte',
	rollup_select_target_placeholder: 'Spalte auswählen...',
	rollup_select_function: '3. Aggregation',
	rollup_no_relations: 'Keine Relationsspalten gefunden. Fügen Sie zuerst eine Relationsspalte hinzu.',
	rollup_fn_sum: 'Summe',
	rollup_fn_count: 'Anzahl',
	rollup_fn_avg: 'Durchschnitt',
	rollup_fn_min: 'Min',
	rollup_fn_max: 'Max',
	rollup_fn_count_values: 'Eindeutige zählen',
	rollup_fn_list: 'Alle auflisten',
	type_image: 'Bild',
	type_audio: 'Audio',
	...
	formula_desc_comparators: 'Vergleicht zwei Werte; mit Bedingungen kombinieren',
	...
	// Hierarchy / Sub-rows
	hierarchy_toggle: 'Als hierarchie verwenden',
	hierarchy_toggle_hint: 'Ermöglicht Eltern-Kind-Beziehungen zwischen Zeilen in dieser Datenbank',
	add_subrow: 'Unterzeile hinzufügen',
	collapse_all: 'Alle einklappen',
	expand_all: 'Alle ausklappen',
	max_depth_reached: 'Maximale tiefe erreicht (3 Ebenen)',
	...
	tooltip_toggle_and_or: 'Klicken, um den logischen Operator zu wechseln',
	...
	conditional_formatting: 'Bedingte formatierung',
	no_conditional_formats: 'Noch keine regeln',
