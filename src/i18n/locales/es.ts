...
const es: Partial<Record<keyof typeof en, string>> = {
	...
	date_format_preset_label: 'Predefinido',
	date_format_pattern_label: 'Patrón',
	date_format_custom: 'Personalizado',
	configure_image_folder: 'Configurar carpeta de imágenes',
	field_type_label: 'Tipo de campo',
	system_fields_label: 'Campos de sistema',
	created_time: 'Fecha de creación',
	last_edited_time: 'Última edición',
	system_field_readonly: 'Campo de solo lectura de los metadatos del archivo',
	...
	db_settings_template_folder_name: 'Carpeta de plantillas',
	db_settings_template_folder_desc: 'Mostrar solo plantillas de esta carpeta al elegir una plantilla para esta base de datos.',
	db_settings_template_folder_choose: 'Elegir carpeta',
	db_settings_template_folder_none: 'Todo el vault (sin restricción)',
